<nav class="breadcrumb-nav">
    <div class="container">
        <ul class="breadcrumb shop-breadcrumb bb-no">
            <li><a href="account.php?a=cart">Shopping Cart</a></li>
            <li class="active"><a href="account.php?a=checkout">Checkout</a></li>
            <li><a href="account.php?a=order_complete">Order Complete</a></li>
        </ul>
    </div>
</nav>
        ...
        <form class="form checkout-form" action="#" method="post">
            <div class="row mb-9">
                ...
                <div class="col-lg-5 mb-4 sticky-sidebar-wrapper">
                    <div class="pin-wrapper" style="height: 946.625px;">
                        <div class="order-summary-wrapper sticky-sidebar" style="border-bottom: 1px solid rgb(238, 238, 238); width: 415.663px;">
